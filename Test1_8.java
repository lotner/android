...
public class Test1_8 extends AppCompatActivity {
    public int count = 8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_8);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_8.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer33);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer34);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer35);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer36);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_8.this, Test1_9.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_8.this, Test1_9.class);
