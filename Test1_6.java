...
public class Test1_6 extends AppCompatActivity {
    public int count = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_6);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_6.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer25);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer26);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer27);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer28);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent intent = new Intent(Test1_6.this, Test1_7.class);
                    intent.putExtra("mark", mark);
                    startActivity(intent);
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_6.this, Test1_7.class);
