    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_4.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer17);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer18);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer19);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer20);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_4.this, Test1_5.class);
