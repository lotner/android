...
public class Test1_7 extends AppCompatActivity {
    public int count = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_7);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_7.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer29);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer30);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer31);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer32);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent intent = new Intent(Test1_7.this, Test1_8.class);
                    intent.putExtra("mark", mark);
                    startActivity(intent);
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_7.this, Test1_8.class);
                        startActivity(inten);finish();
                    }catch (Exception e) {
                    }
                }
                return true;
