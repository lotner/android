    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_2.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer9);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer10);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer11);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer12);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent intent = new Intent(Test1_2.this, Test1_3.class);
                    intent.putExtra("mark", mark);
                    startActivity(intent);
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_2.this, Test1_3.class);
