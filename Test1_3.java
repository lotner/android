    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_3.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer13);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer14);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer15);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer16);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent intent = new Intent(Test1_3.this, Test1_4.class);
                    intent.putExtra("mark", mark);
                    startActivity(intent);
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_3.this, Test1_4.class);
