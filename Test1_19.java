...
public class Test1_19 extends AppCompatActivity {
    public int count = 19;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_19);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_19.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer77);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer78);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer79);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer80);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_19.this, Test1_20.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_19.this, Test1_20.class);
