...
public class Test1_17 extends AppCompatActivity {
    public int count = 17;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_17);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_17.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer69);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer70);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer71);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer72);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_17.this, Test1_18.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_17.this, Test1_18.class);
