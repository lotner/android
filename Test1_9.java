...
public class Test1_9 extends AppCompatActivity {
    public int count = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_9);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_9.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer37);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer38);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer39);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer40);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_9.this, Test1_10.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_9.this, Test1_10.class);
