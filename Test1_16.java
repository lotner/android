...
public class Test1_16 extends AppCompatActivity {
    public int count = 16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_16);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_16.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer65);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer66);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer67);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer68);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_16.this, Test1_17.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_16.this, Test1_17.class);
