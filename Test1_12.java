...
public class Test1_12 extends AppCompatActivity {
    public int count = 12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_12);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_12.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer49);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer50);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer51);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer52);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_12.this, Test1_13.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_12.this, Test1_13.class);
