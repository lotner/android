...
public class Test1_11 extends AppCompatActivity {
    public int count = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_11);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_11.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer45);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer46);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer47);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer48);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_11.this, Test1_12.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_11.this, Test1_12.class);
