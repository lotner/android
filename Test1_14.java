...
public class Test1_14 extends AppCompatActivity {
    public int count = 14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_14);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_14.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer57);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer58);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer59);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer60);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_14.this, Test1_15.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_14.this, Test1_15.class);
