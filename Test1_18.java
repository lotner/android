...
public class Test1_18 extends AppCompatActivity {
    public int count = 18;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_18);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_18.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer73);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer74);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer75);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer76);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_18.this, Test1_19.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_18.this, Test1_19.class);
