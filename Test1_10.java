...
public class Test1_10 extends AppCompatActivity {
    public int count = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test1_10);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_10.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer41);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer42);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer43);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer44);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent inten = new Intent(Test1_10.this, Test1_11.class);
                    inten.putExtra("mark", mark);
                    startActivity(inten);
                    //переход дальше
                    try{
                        Intent intent = new Intent(Test1_10.this, Test1_11.class);
