...
public class Test1_5 extends AppCompatActivity {
    public int count = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Test1_5.this, Tests.class);
        ...
        TextView answer1 = (TextView) findViewById(R.id.test1_answer21);
        TextView answer2 = (TextView) findViewById(R.id.test1_answer22);
        TextView answer3 = (TextView) findViewById(R.id.test1_answer23);
        TextView answer4 = (TextView) findViewById(R.id.test1_answer24);
        answer1.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { //нажали кнопку
                    ...
                    Intent intent = new Intent(Test1_5.this, Test1_6.class);
                    intent.putExtra("mark", mark);
                    startActivity(intent);
                    //переход дальше
                    try{
                        Intent inten = new Intent(Test1_5.this, Test1_6.class);
